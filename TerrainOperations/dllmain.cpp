...
ex double terrainops_build_settings(double save_all, double swap_zup, double swap_handedness, double swap_uv, double center, double density, double scale, double tex_size, double color_scale, double format, double water_level, double save_smooth_normals) {
