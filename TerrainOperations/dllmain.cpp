...
ex double terrainops_build_settings(double swap_zup, double swap_uv, double center, double density, double width, double height, double scale) {
	terrainops::build_settings((bool)swap_zup, (bool)swap_uv, (bool)center, (int)density, (float)width, (float)height, (float)scale);
	return 1.0;
}
