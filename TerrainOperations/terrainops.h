...
#define __DRAGO_TERRAIN_OP "1.0.3"
...
namespace terrainops {
	...
	extern bool save_swap_handedness;
	...
	// build vertex data
	void build_settings(bool, bool, bool, bool, bool, int, float, float, float, unsigned int, float, bool);
